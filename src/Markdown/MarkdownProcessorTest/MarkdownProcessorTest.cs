...
public class MarkdownProcessorTest
{
    ...
    private readonly MdProcessor _markdownProcessor;

    public MarkdownProcessorTest(ITestOutputHelper testOutputHelper)
    {
    ...
    [InlineData("Жирный c __цифра1ми__ снаружи", "<div>Жирный c __цифра1ми__ снаружи</div>")]
    [InlineData("Жирный c __цифр__а1ми__ и внутри и снаружи", "<div>Жирный c __цифр__а1ми__ и внутри и снаружи</div>")]
    ...
    [InlineData("Курсив c _цифра1ми_ снаружи", "<div>Курсив c _цифра1ми_ снаружи</div>")]
    [InlineData("Курсив c _цифр_а1ми_ и внутри и снаружи", "<div>Курсив c _цифр_а1ми_ и внутри и снаружи</div>")]
    ...
    [InlineData("В случае __пересечения _двойных__ и одинарных_ подчерков один из них считается выделением", "<div>В случае <strong>пересечения _двойных</strong> и одинарных_ подчерков один из них считается выделением</div>")]
    ...
    //<div><h1> Заголовок с <strong>жирным</strong>текстом</h1></div>
    //<div><h1>Заголовок с <strong>жирным</strong> текстом</h1></div>
